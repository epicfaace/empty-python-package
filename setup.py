"""Python setup.py for empty_python_package package"""
import io
import os
...
def read(*paths, **kwargs):
    ...
    >>> read("empty_python_package", "VERSION")
    '0.1.0'
    >>> read("README.md")
    ...
    """
...
setup(
    ...
    entry_points={
        "console_scripts": ["empty_python_package = empty_python_package.__main__:main"]
    },
